...
return [
    ...
    */
    ...
    'active_url'      => ':attribute 不是壹個有效的網址。',
    ...
    'emoji'        => ':attribute 不允許使用表情符，請使用符合要求的 UTF-8 字符。',
    'parent_directory'        => ':attribute 不允許出現名為 .. 的子目錄。',
    'un_starts_with' => ':attribute 不能以 :values 為開頭。',
    'continuous_character' => ':attribute 不能出現連續的 :values。',

    /*
    |--------------------------------------------------------------------------
    | Custom Validation SetLocale Lines
    |--------------------------------------------------------------------------
    |
