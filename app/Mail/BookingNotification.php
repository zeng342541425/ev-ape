 ...
 * 餐廳/飯店 預約成功 通知商家
 */
class BookingNotification extends BaseMail
{

    public $subject = '【EVAPE預定】{user_name}已預定{number}個{booking_date} {time}【{shop_name}】';
    public $user_name;
    public $shop_name;
    public $number;
    public $booking_date;
    ...
    {
        return $this->subject($this->subject)->view('mail.booking');
    }
}
